...
@Entity
@Table(name = "ccf_evidence_mapping",
       uniqueConstraints = @UniqueConstraint(columnNames = {"ccf_point_id", "evidence_request_id"}))
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class CCFEvidenceMapping {
    ...
    private EvidenceRequestList evidenceRequest;
